...
function Card(props) {
  ...
  let priceOptions = Object.keys(options);// options according to the list stored in the database
  ...
  return (
    <div>
      <div className="card mt-3 " style={{ width: "18rem", maxHeight: "360px" }}>
        <img  className="card-img-top" src={props.foodItem.img} alt="..." style={{height:"20vh", objectFit:"fill"}} />
